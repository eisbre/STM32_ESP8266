...
#define DEVID		"8266"//多次连接不上服务器修改这个值
...
/**
  * @brief  订阅主题
  * @param  topics：订阅的topic		topic_cnt：topic个数
  * @retval SEND_TYPE_OK-成功	SEND_TYPE_SUBSCRIBE-需要重发
  */
...
/**
  * @brief  发布消息
  * @param  topic：发布的主题	msg：消息内容
  * @retval SEND_TYPE_OK-成功	SEND_TYPE_PUBLISH-需要重送
  */
