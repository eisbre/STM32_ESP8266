...
/**
  * @brief  Subscribe的回复消息解包
  * @param  rev_data：接收到的信息
  * @retval 0-成功		其他-失败
  */
...
/**
  * @brief  Publish Ack消息组包,当收到的Publish消息的QoS等级为1时，需要Ack回复
  * @param  pkt_id：packet id	mqttPacket：包指针
  * @retval 0-成功		1-失败原因
  */
...
/**
  * @brief  Publish Ack消息解包
  * @param  rev_data：收到的数据
  * @retval 0-成功		1-失败原因
  */
...
/**
  * @brief  Publish Rec消息组包,当收到的Publish消息的QoS等级为2时，先收到rec
  * @param  pkt_id：packet id	mqttPacket：包指针
  * @retval 0-成功		1-失败原因
  */
...
/**
  * @brief  Publish Rec消息解包
  * @param  rev_data：接收到的数据
  * @retval 0-成功		1-失败
  */
...
/**
  * @brief  Publish Rel消息组包,当收到的Publish消息的QoS等级为2时，先收到rec，再回复rel
  * @param  pkt_id：packet id	mqttPacket：包指针
  * @retval 0-成功		1-失败原因
  */
...
/**
  * @brief  Publish Comp消息组包,当收到的Publish消息的QoS等级为2时，先收到rec，再回复rel
  * @param  pkt_id：packet id	mqttPacket：包指针
  * @retval 0-成功		1-失败原因
  */
